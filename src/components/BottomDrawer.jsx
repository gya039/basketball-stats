export default function BottomDrawer({
  ...
  return (
    <div className={`bottom-panel-court drawer-panel ${bottomPanelOpen ? 'open' : 'closed'}`}>
      <div className="drawer-header">
        ...
        >
          {bottomPanelOpen ? 'Hide' : 'Show'}
        </button>
      </div>

      {bottomPanelOpen && panelView === 'log' && (
